...
/* DCMI sub commond for DSMI_MAIN_CMD_SEC */
...
DCMIDLLEXPORT int dcmi_get_os_version(char *os_ver, unsigned int len);
...
DCMIDLLEXPORT int dcmi_set_sleep_state(int card_id, int device_id, struct dcmi_power_state_info_stru power_info);
